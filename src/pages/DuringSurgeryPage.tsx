          ...
          {currentLanguage === 'si' ? (
            <>
              <div>
                ...
                <p>
                  සාමාන්‍ය නිර්වින්දනය ක්‍රියා කරන්නේ කැනියුලාව හරහා එන්නත් කරන ඖෂධවල සංයෝගයක් හරහාය:
                </p>
              ...
              <div className="mt-4">
                ...
                <p className="mt-2">
                  ශල්‍යකර්මය අවසන් වන විට නිර්වින්දය සාමාන්‍යයෙන් පැය 2-4 අතර කාලයක් ඇතුළත ඉවත් වේ.
                </p>
              </div>
